...
const CharacterTabs = async ({ characters }: { characters: IUidSearchResult[] }): Promise<React.ReactElement> => {
        ...
        {characters.map((character) => {
          ...
          return (
            <TabsTrigger
              ...
              value={name}
            >
              <Image src={iconUrl} alt="" priority fill sizes="(max-width: 1200px) 5vw, 5vw" />
            </TabsTrigger>
          );
        })}
      </TabsList>
