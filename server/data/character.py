...
passiveSkill = {
    "감우": {
        "단 하나의 마음": passiveSkillModel(
            description="강공격 후 강공격 치명타 확률 증가", unlockLevel=1, options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")]
        ),
        "천지교태": passiveSkillModel(
    ...
    "카미사토 아야카": {
        "천죄국죄 진사": passiveSkillModel(
            description="원소 전투 스킬 발동 후 일반공격 및 강공격 피해 증가",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")],
        ),
        "한천선명 축사": passiveSkillModel(
            description="싸락눈 걸음 명중 후 얼음 원소 피해 증가", unlockLevel=4, options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")]
        ),
    },
    "각청": {
        "하늘에 닿은 뇌벌": passiveSkillModel(
            description="원소 전투 스킬 발동 후 번개 원소 인챈트", unlockLevel=1, options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")]
        ),
        "옥형의 품격": passiveSkillModel(
    ...
    "나히다": {
        "정선으로 포용한 명론": passiveSkillModel(
            description="원소 폭발 발동 시 원소마스터리 증가", unlockLevel=1, options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")]
        ),
        "지혜로 깨우친 지론": passiveSkillModel(
            description="원소 마스터리 200pt 초과 시 초과분 1pt 당 원소 전투 스킬의 삼업의 정화가 가하는 피해 및 치명타 확률 증가",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.always, maxStack=1, label="")],
        ),
    },
    "라이덴 쇼군": {
        "수천수만의 염원": passiveSkillModel(
            description="원소 입자 획득 시 원력 스텍 추가", unlockLevel=1, options=[skillConstellationOptionModel(type=skillConstellationType.always, maxStack=1, label="")]
        ),
        "비범한 옥체": passiveSkillModel(
    ...
    "야란": {
        "선공의 묘수": passiveSkillModel(
            description="파티 내 캐릭터의 원소 타입 종류 마다 야란의 최대 hp 증가",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=4, label="원소 타입 종류 수")],
        ),
        "마음 가는 대로": passiveSkillModel(
            description="원소 폭발 발동 시 필드 위 캐릭터가 가하는 피해가 1초마다 증가",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=14, label="경과 시간(초)")],
        ),
    },
    "푸리나": {
        "끝없는 왈츠": passiveSkillModel(
            description="필드 위 캐릭터가 치유 받을 시 푸리나의 치유가 아닌 동시에 회복량이 초과된 경우 주변 파티 내 캐릭터 hp 회복",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.always, maxStack=1, label="")],
        ),
        "고독한 독백": passiveSkillModel(
    ...
    "시틀라리": {
        "다섯 번째 하늘의 서리비": passiveSkillModel(
            description="융해 반응 발동 시 반응에 영향을 받은 적의 물 원소 및 불 원소 내성 감소",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")],
        ),
        "하얀 불나비의 별옷": passiveSkillModel(
    ...
    "느비예트": {
        "생존한 고대바다의 계승자": passiveSkillModel(
            description="물 원소 관련 반응 발동 시 강공격 피해 증가",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=3, label="생존한 용의 영광")],
        ),
        "드높은 중재의 규율": passiveSkillModel(
            description="현재 hp 중 hp 최대치의 30%를 초과하는 부분을 기반으로 1% 당 물 원소 피해 증가",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=50, label="hp 최대치 초과분(%)")],
        ),
    },
    "마비카": {
        "타오르는 꽃의 선물": passiveSkillModel(
            description="파티 내 캐릭터가 밤혼 발산 발동 시 마비카의 공격력 증가",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")],
        ),
        "「키온고지」": passiveSkillModel(
            description="원소 폭발 발동 후 발동 당시 전의 스텍 1pt당 피해 증가 및 지속 시간 동안 점차 감소",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=200, label="전의")],
        ),
    },
    "에스코피에": {
        "밥이 보약": passiveSkillModel(
            description="원소 폭발 발동 후 파티 내 모든 캐릭터 hp 회복",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.toggle, maxStack=1, label="")],
        ),
        "영감의 조미료": passiveSkillModel(
            description="원소 전투 스킬 또는 원소 폭발 명중 시 파티 내 물 원소 캐릭터 또는 얼음 원소 캐릭터 수 마다 명중한 적 물 원소 내성 및 얼음 원소 내성 감소",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=4, label="물 또는 얼음 원소 파티원 수")],
        ),
    },
    "스커크": {
        "이치 너머의 이치": passiveSkillModel(
            description="빙결, 초전도, 얼음 확산, 얼음 결정 반응 발동 시 허계 균열 1개 생성. 허계 균열은 흡수 가능하며 흡수 시 원소 전투 스킬 및 원소 폭발 계수 증가",
            unlockLevel=1,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=3, label="흡수 허계 균열 수")],
        ),
        "흐름의 적멸": passiveSkillModel(
            description="파티 내 주변에 있는 물 원소 또는 얼음 원소 캐릭터가 각각 물 원소 또는 얼음 원소 공격으로 적 명중 시 최종 데미지 증가(마지막 곱연산)",
            unlockLevel=4,
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=3, label="죽음의 강")],
        ),
    },
}
...
activeSkill = {
    ...
    "나히다": {
        "마음이 그리는 환상": activeSkillModel(
            ...
            options=[
                skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=2, label="불"),
...
constellation = {
    "감우": [
        ...
        contellationModel(
            ...
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=5, label="피해 증가 중첩")],
        ),
        contellationModel(
            name="잡초 근절",
    ...
    "각청": [
        ...
        contellationModel(
            ...
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=3, label="번개 원소 피해 보너스")],
        ),
    ],
    "나히다": [
        contellationModel(
        ...
        contellationModel(
            ...
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=4, label="스칸다 씨앗 상태 적 수")],
        ),
        contellationModel(
            name="깨달음을 주는 잎",
            description="원소 폭발 레벨 +3",
    ...
    "야란": [
        ...
        contellationModel(
            ...
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=4, label="명중 적 수")],
        ),
        contellationModel(
            name="눈보다 빠른 손",
            description="원소 전투 스킬 레벨 +3",
    ...
    "시틀라리": [
        ...
        contellationModel(
            ...
            options=[skillConstellationOptionModel(type=skillConstellationType.stack, maxStack=40, label="밤혼 소모")],
        ),
    ],
    "마비카": [
        contellationModel(
