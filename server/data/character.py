...
constellation = {
    "감우": [
        ...
        {"name": "구름 여행", "type": skillConstellationType.always, "maxStack": 1, "description": "원고 폭발 레벨 +3"},
        {
            "name": "서수(西狩)",
            "type": skillConstellationType.stack,
            "maxStack": 5,
    ...
    "각청": [
        ...
        {"name": "등루", "type": skillConstellationType.always, "maxStack": 1, "description": "원소 폭발 레벨 +3"},
        {
            "name": "조율",
            "type": skillConstellationType.toggle,
            "maxStack": 1,
        ...
        {"name": "이등", "type": skillConstellationType.always, "maxStack": 1, "description": "원소 전투 스킬 레벨 +3"},
        {
            "name": "염정",
            "type": skillConstellationType.stack,
            "maxStack": 3,
    ...
    "야란": [
        ...
        },
        {
            ...
            "type": skillConstellationType.always,
            "maxStack": 1,
            "description": "원소 폭발의 협동 공격 시 야란 hp 최대치의 14%의 추가 데미지",
        },
        {
            "name": "노름꾼의 주사위",
            "type": skillConstellationType.always,
    ...
    "푸리나": [
        ...
        },
        {
            ...
            "type": skillConstellationType.toggle,
            "maxStack": 1,
            "description": "원소 폭발 시간 동안 무대 열기 당 hp최대치 증가",
        },
        {
    ...
    "스커크": [
        ...
        {"name": "악연", "type": skillConstellationType.always, "maxStack": 1, "description": "원소 폭발 레벨 +3"},
        {
            "name": "멸류",
            "type": skillConstellationType.always,
            "maxStack": 1,
