...
activeSkill = {
    ...
    "나히다": {
        "마음이 그리는 환상": activeSkillType(
            type=skillConstellationType.toggle, maxStack=2, description="파티 내 불, 번개, 물 원소 타입 캐릭터가 있으면 각각 상응하는 효과가 발생"
        )
    },
    "라이덴 쇼군": {"초월 · 악요개안": activeSkillType(type=skillConstellationType.toggle, maxStack=1, description="원소 폭발의 원소 에너지 당 원소 폭발 피해 증가")},
    "호두": {"나비의 서": activeSkillType(type=skillConstellationType.toggle, maxStack=1, description="현재 hp의 30%를 소비하여 hp 최대치 기반 공격력 증가")},
    "야란": {},
    "푸리나": {"성대한 카니발": activeSkillType(type=skillConstellationType.stack, maxStack=300, description="무대 열기 당 피해 증가 및 치유 보너스 증가")},
    "시틀라리": {},
    "느비예트": {},
    "마비카": {},
    "에스코피에": {},
...
constellation = {
    "감우": [
        contellationType(name="이슬 먹는 신수", type=skillConstellationType.toggle, maxStack=1, description="2단 차지 강공격 또는 서리꽃에 명중된 적의 얼음 원소 내성 감소 15%"),
        contellationType(name="획린(獲麟)", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 사용 가능 횟수 1회 증가"),
        contellationType(name="구름 여행", type=skillConstellationType.always, maxStack=1, description="원고 폭발 레벨 +3"),
        contellationType(name="서수(西狩)", type=skillConstellationType.stack, maxStack=5, description="원소 폭발 영역 내에서 적이 받는 피해 증가"),
        contellationType(name="잡초 근절", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(name="살생의 발걸음", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 발동 시 첫 번째 서리꽃 화살은 차징 없이 발동"),
    ],
    "카미사토 아야카": [
        contellationType(
            name="서리에 검게 물든 벚꽃",
        ...
        contellationType(name="화운종월경", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(name="물에 비친 달", type=skillConstellationType.toggle, maxStack=1, description="10초마다 강공격 피해를 0.5초간 증가"),
    ],
    "각청": [
        contellationType(
            name="계뢰", type=skillConstellationType.always, maxStack=1, description="뇌설이 존재하는 동안 다시 원소 전투 스킬 발동 시 공격력의 50%의 번개 원소 피해 추가"
        ),
        contellationType(
            name="가연", type=skillConstellationType.always, maxStack=1, description="일반 공격 또는 강공격이 번개 원소 영향을 받은 적 공격 시 50% 확률로 원소 입자 생성"
        ),
        contellationType(name="등루", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(name="조율", type=skillConstellationType.toggle, maxStack=1, description="각청이 번개 원소 관련 반응 발동 뒤 10초간 공격력 25% 증가"),
        contellationType(name="이등", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="염정",
            type=skillConstellationType.stack,
            maxStack=3,
    ...
    "나히다": [
        ...
        contellationType(name="감화된 성취의 싹", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(name="추론으로 드러난 줄기", type=skillConstellationType.stack, maxStack=4, description="스칸다 씨앗 상태에 있는 적 수당 나히다의 원소 마스터리 증가"),
        contellationType(name="깨달음을 주는 잎", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(
            name="달변으로 맺은 열매",
            type=skillConstellationType.toggle,
            maxStack=1,
    ...
    "라이덴 쇼군": [
        contellationType(name="악요 명문(銘文)", type=skillConstellationType.always, maxStack=1, description="염원이 깃든 백안지륜이 더욱 빠르게 원력을 축적"),
        contellationType(name="강철 절단", type=skillConstellationType.toggle, maxStack=1, description="원소 폭발 상태 시 적의 방여력 60%를 무시한다"),
        contellationType(name="진영의 과거", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(name="진리의 맹세", type=skillConstellationType.toggle, maxStack=1, description="원소 폭발 종료 후 라이덴 쇼군을 제외한 파티원의 공력력 30% 증가"),
        contellationType(name="쇼군의 현형", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="염원의 대행인",
            type=skillConstellationType.always,
            maxStack=1,
    ...
    "호두": [
        contellationType(name="진홍의 꽃다발", type=skillConstellationType.always, maxStack=1, description="피안접무 상태일 때 강공격에 스테미너를 사용하지 않는다"),
        contellationType(name="비처럼 내리는 불안", type=skillConstellationType.always, maxStack=1, description="혈매향의 피해가 hp최대치의 10%만큼 증가"),
        contellationType(name="적색 피의 의식", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="영원한 안식의 정원", type=skillConstellationType.toggle, maxStack=1, description="혈매향 상태 적 처치 시, 호두를 제외한 파티내 캐릭터의 치명타 확률 12% 증가"
        ),
        contellationType(name="꽃잎 향초의 기도", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(
            name="나비 잔향",
            type=skillConstellationType.toggle,
            maxStack=1,
    ...
    "야란": [
        ...
        contellationType(name="승자의 독식", type=skillConstellationType.toggle, maxStack=1, description="원소 폭발 발동 시 일반공격 피해 증가 및 일반공격을 강공격으로 취급"),
    ],
    "푸리나": [
        contellationType(
        ...
        contellationType(name="「난 알았노라, 그대의 이름은…!」", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="「모두 사랑의 축배를 들렴!」",
            type=skillConstellationType.toggle,
            maxStack=1,
    ...
    "시틀라리": [
        ...
        contellationType(name="불길한 닷새의 저주", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(
            name="아홉 번째 하늘의 계약",
            type=skillConstellationType.stack,
            maxStack=40,
    ...
    "마비카": [
        contellationType(name="밤 주인의 계시", type=skillConstellationType.toggle, maxStack=1, description="전의 획득 후 공력력 40% 증가"),
        contellationType(
            name="잿더미의 대가", type=skillConstellationType.always, maxStack=1, description="기초 공격력 200pt 증가. 일반공격, 강공격, 원소폭발의 석양 베기로 주는 피해 증가"
        ),
        contellationType(name="타오르는 태양", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(name="「지도자」의 각오", type=skillConstellationType.always, maxStack=1, description="키온고지 효과 강화"),
        contellationType(name="진정한 의미", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="「인간의 이름」 해방",
            type=skillConstellationType.toggle,
            maxStack=1,
    ...
    "느비예트": [
        contellationType(name="위대한 제정", type=skillConstellationType.always, maxStack=1, description="생존한 용의 영광을 1 스택 획득 및 강공격 시 경직 저항력 증가"),
        contellationType(name="법의 계율", type=skillConstellationType.always, maxStack=1, description="생존한 용의 영광 1스텍 당 강공격 치명타 피해 14% 증가"),
        contellationType(name="고대의 의제", type=skillConstellationType.always, maxStack=1, description="일반공격 스킬 레벨 +3"),
        contellationType(name="연민의 왕관", type=skillConstellationType.always, maxStack=1, description="치유 받을 시 원천의 방울 1개 생성"),
        contellationType(name="정의의 판결", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(name="분노의 보상", type=skillConstellationType.always, maxStack=1, description="강공격 명중 시 hp최대치의 10% 물 원소 피해를 주는 격류 2개 소환"),
    ],
    "에스코피에": [
        contellationType(
            name="미각을 깨우는 식전 공연",
        ...
        contellationType(name="캐러멜화의 마법", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="로즈마리 비밀 레시피", type=skillConstellationType.always, maxStack=1, description="식이 요법 지속시간 증가 및 식이 요법으로 치유 시 원소 에너지 획득"
        ),
        contellationType(name="다채로운 소스의 교향곡", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(
            name="무지갯빛 티타임",
            type=skillConstellationType.always,
            maxStack=1,
    ...
    "스커크": [
        contellationType(
            name="요원", type=skillConstellationType.always, maxStack=1, description="허계 균열 1개 흡수할 때 마다 스커크 공격력의 500%에 해당하는 얼음 원소 피해 추가"
        ),
        contellationType(
            name="심연",
            type=skillConstellationType.toggle,
        ...
        contellationType(name="악연", type=skillConstellationType.always, maxStack=1, description="원소 폭발 레벨 +3"),
        contellationType(name="멸류", type=skillConstellationType.always, maxStack=1, description="죽음의 강 효과 스텍마다 공격력 증가"),
        contellationType(name="소망", type=skillConstellationType.always, maxStack=1, description="원소 전투 스킬 레벨 +3"),
        contellationType(
            name="근원",
            type=skillConstellationType.always,
            maxStack=1,
